    ...
    let arrayValues = ['region','facilities','vendor','lane'];
      for (let i = 0; i < 5000; i++) {
          data.push({
              ...
              truck_load:faker.datatype.number({ min: 1, max: 100}),
              inter_modal:faker.datatype.number({ min: 1, max: 100}),
              cost:faker.datatype.number({ min: 100, max: 10000, precision: 0.01 }),
              service:faker.datatype.number(500),
              currency:'$',
              date: faker.date.between('2011-01-01T00:00:00.000Z', '2022-12-01T00:00:00.000Z'),
              emission_toggle:1,
